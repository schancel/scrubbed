...
shasum -a 256 "$tmpdir/zstd-1.5.7.tar.gz"
# Require: eb33e51f49a15e023950cd7825ca74a4a2b43db8354825ac24fc1b7ee09e6fa3
...
committed or used by the project build. Verify hash before extraction; the
commands show the hash, but do not automatically enforce it. Use the exact
expected hash as an equality check before running `tar` on untrusted input.
...
`Content-Length`, and the two CRLF terminators. It does not implement field
...
implementation of either compression format.
